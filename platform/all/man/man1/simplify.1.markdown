simplify(1) -- Simplifies fractions when you're too lazy to!
============================================================

## SYNOPSIS

`simplify` [<var>fraction</var> | <var>numerator</var> <var>denominator</var>]

## DESCRIPTION

Simplifies fractions. Fractions may be supplied as a <var>fraction</var> in the form numerator/denominator, or may be supplied with the <var>numerator</var> and <var>denominator</var> as separate arguments.
